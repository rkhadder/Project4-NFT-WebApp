 ...
 */
export async function connectToWallet(network: ethers.providers.Networkish = "goerli") : Promise<connectToWalletOutput> {
    ...
    const provider = ethers.providers.getDefaultProvider(network, providerOptions);
